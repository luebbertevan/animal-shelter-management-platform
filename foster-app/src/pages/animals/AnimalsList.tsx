						...
						<div className="flex items-center gap-2 sm:gap-3">
							{profile.role === "coordinator" && (
								<>
									<Link to="/animals/new">
										<Button
											className="h-10 w-10 px-0 py-0 sm:h-auto sm:w-auto sm:px-5 sm:py-2.5 whitespace-nowrap text-sm"
									...
									<Link to="/animals/bulk-add">
										<Button
											variant="outline"
											className="h-10 min-h-10 w-auto px-3 py-0 sm:h-auto sm:min-h-0 sm:px-5 sm:py-2.5 whitespace-nowrap text-sm"
