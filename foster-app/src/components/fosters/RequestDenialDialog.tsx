...
interface RequestDenialDialogProps {
	isOpen: boolean;
	onClose: () => void;
...
export default function RequestDenialDialog({
	isOpen,
	onClose,
	onConfirm,
	fosterName,
	animalOrGroupName,
}: RequestDenialDialogProps) {
	...
	const defaultMessage = `Thank you for your interest in fostering ${animalOrGroupName}. Unfortunately, we're unable to assign them to you at this time.`;
					...
					<div className="px-4 py-4">
						...
						<div className="mb-4">
							...
							<p className="mt-1 text-xs text-gray-500">
								Add any information about why you're denying this request
								(optional).
							</p>
							<p className="mt-1 text-xs text-gray-500">
